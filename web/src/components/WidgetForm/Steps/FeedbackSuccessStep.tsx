...
export function FeedbackSuccessStep({onFeedbackRestartRequested}:FeedbackSuccessStepProps) {
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center py-18 w-[384px]">
        <svg
          width="41"
          height="40"
          viewBox="0 0 41 40"
        ...
        <button onClick={onFeedbackRestartRequested} className="py-2 px-6 my-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus: ring-offset-zinc-900 focus:ring-brand-500">Quero enviar outro</button>
      </div>
    </>
  );
}
